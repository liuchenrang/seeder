...
func Usage() {
  ...
  fmt.Fprintln(os.Stderr, "  string getId(TGetIdParams params)")
  fmt.Fprintln(os.Stderr)
  os.Exit(0)
}
...
func main() {
  ...
  client := generator.NewIdGeneratorServiceClient(thrift.NewTStandardClient(iprot, oprot))
  ...
  case "getId":
    ...
    argvalue0 := generator.NewTGetIdParams()
    ...
    value0 := argvalue0
    fmt.Print(client.GetId(context.Background(), value0))
    fmt.Print("\n")
    break
  case "":
    Usage()
